...
| X-SP-Formular-Stage   | WorkflowStage des Formulars<ul><li>`MODELLING`</li><li>`QUALITY_ASSURANCE`</li><li>`CERTIFIED`</li></ul> <b>*Deprecated:</b> Header wird mit folgenden Versionen vollständig entfernt. Migration erfoderlich falls noch genutzt, <br/> siehe [Migration Guide](migration.md)  |
